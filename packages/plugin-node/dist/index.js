...
var ImageDescriptionService = class _ImageDescriptionService extends Service3 {
  ...
  async initializeProvider() {
    ...
    if (this.runtime.imageVisionModelProvider) {
      if (this.runtime.imageVisionModelProvider === ModelProviderName.LLAMALOCAL) {
        this.provider = new LocalImageProvider();
        elizaLogger3.debug("Using llama local for vision model");
  ...
  async loadImageData(imageUrl) {
    ...
    if (isGif) {
      ...
      imageData = fs2.readFileSync(filePath);
      mimeType = "image/png";
      fs2.unlinkSync(filePath);
    } else {
      if (fs2.existsSync(imageUrl)) {
        imageData = fs2.readFileSync(imageUrl);
        const ext = path2.extname(imageUrl).slice(1);
...
var AgentLiveClient = class extends AbstractLiveClient {
  ...
  configure(options) {
    var _a2, _b, _c;
    if (!options.agent.listen.model.startsWith("nova-3") && ((_a2 = options.agent.listen.keyterm) === null || _a2 === void 0 ? void 0 : _a2.length)) {
...
var ListenLiveClient = class extends AbstractLiveClient {
  ...
  constructor(options, transcriptionOptions = {}, endpoint = ":version/listen") {
    ...
    if (((_a2 = transcriptionOptions.keyterm) === null || _a2 === void 0 ? void 0 : _a2.length) && !((_b = transcriptionOptions.model) === null || _b === void 0 ? void 0 : _b.startsWith("nova-3"))) {
      throw new DeepgramError("Keyterms are only supported with the Nova 3 models.");
    }
  ...
  transcribeUrl(source, options, endpoint = ":version/listen") {
    ...
    return __awaiter5(this, void 0, void 0, function* () {
      try {
        ...
        if (((_a2 = options === null || options === void 0 ? void 0 : options.keyterm) === null || _a2 === void 0 ? void 0 : _a2.length) && !((_b = options.model) === null || _b === void 0 ? void 0 : _b.startsWith("nova-3"))) {
          throw new DeepgramError("Keyterms are only supported with the Nova 3 models.");
        }
