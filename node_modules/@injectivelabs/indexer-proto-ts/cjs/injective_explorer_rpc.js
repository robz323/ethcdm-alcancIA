...
function createBaseCursor() {
    return { from: 0, to: 0, next: [], total: "0" };
}
exports.Cursor = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.from !== 0) {
            writer.uint32(8).sint32(message.from);
        }
        if (message.to !== 0) {
            writer.uint32(16).sint32(message.to);
        }
        for (const v of message.next) {
            writer.uint32(26).string(v);
        }
        if (message.total !== "0") {
            writer.uint32(32).sint64(message.total);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseCursor();
        message.from = (_a = object.from) !== null && _a !== void 0 ? _a : 0;
        message.to = (_b = object.to) !== null && _b !== void 0 ? _b : 0;
        message.next = ((_c = object.next) === null || _c === void 0 ? void 0 : _c.map((e) => e)) || [];
...
function createBaseGetTxsV2Request() {
    return { type: "", startTime: "0", endTime: "0", perPage: 0, token: "" };
}
