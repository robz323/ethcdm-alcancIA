...
var types_1 = require("../../abci/v1beta2/types.js");
var types_2 = require("../../types/v1beta1/types.js");
var validator_1 = require("../../types/v1beta1/validator.js");
var params_1 = require("../../types/v1beta2/params.js");
var types_3 = require("../v1beta1/types.js");
...
exports.ABCIResponses = {
    ...
    fromJSON: function (object) {
        return {
            deliverTxs: Array.isArray(object === null || object === void 0 ? void 0 : object.deliverTxs)
                ? object.deliverTxs.map(function (e) { return types_1.ResponseDeliverTx.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if (message.deliverTxs) {
            obj.deliverTxs = message.deliverTxs.map(function (e) { return e ? types_1.ResponseDeliverTx.toJSON(e) : undefined; });
        }
        else {
            obj.deliverTxs = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseABCIResponses();
        message.deliverTxs = ((_a = object.deliverTxs) === null || _a === void 0 ? void 0 : _a.map(function (e) { return types_1.ResponseDeliverTx.fromPartial(e); })) || [];
