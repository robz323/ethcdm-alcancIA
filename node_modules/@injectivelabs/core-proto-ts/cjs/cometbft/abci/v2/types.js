...
var params_1 = require("../../types/v2/params.js");
var validator_1 = require("../../types/v2/validator.js");
...
function createBaseVerifyVoteExtensionRequest() {
    return {
        ...
        nonRpVoteExtension: new Uint8Array(),
    };
}
exports.VerifyVoteExtensionRequest = {
    ...
    toJSON: function (message) {
        ...
        message.nonRpVoteExtension !== undefined &&
            (obj.nonRpVoteExtension = base64FromBytes(message.nonRpVoteExtension !== undefined ? message.nonRpVoteExtension : new Uint8Array()));
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.nonRpVoteExtension = (_e = object.nonRpVoteExtension) !== null && _e !== void 0 ? _e : new Uint8Array();
        return message;
    },
};
...
function createBaseExtendVoteResponse() {
    return { voteExtension: new Uint8Array(), nonRpExtension: new Uint8Array() };
}
exports.ExtendVoteResponse = {
    ...
    fromJSON: function (object) {
        return {
            voteExtension: isSet(object.voteExtension) ? bytesFromBase64(object.voteExtension) : new Uint8Array(),
            nonRpExtension: isSet(object.nonRpExtension) ? bytesFromBase64(object.nonRpExtension) : new Uint8Array(),
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.voteExtension !== undefined &&
            (obj.voteExtension = base64FromBytes(message.voteExtension !== undefined ? message.voteExtension : new Uint8Array()));
        message.nonRpExtension !== undefined &&
            (obj.nonRpExtension = base64FromBytes(message.nonRpExtension !== undefined ? message.nonRpExtension : new Uint8Array()));
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.nonRpExtension = (_b = object.nonRpExtension) !== null && _b !== void 0 ? _b : new Uint8Array();
        return message;
    },
};
...
function createBaseExtendedVoteInfo() {
    return {
        ...
        blockIdFlag: 0,
        nonRpVoteExtension: new Uint8Array(),
        nonRpExtensionSignature: new Uint8Array(),
    };
}
exports.ExtendedVoteInfo = {
    ...
    toJSON: function (message) {
        ...
        message.nonRpVoteExtension !== undefined &&
            (obj.nonRpVoteExtension = base64FromBytes(message.nonRpVoteExtension !== undefined ? message.nonRpVoteExtension : new Uint8Array()));
        message.nonRpExtensionSignature !== undefined &&
            (obj.nonRpExtensionSignature = base64FromBytes(message.nonRpExtensionSignature !== undefined ? message.nonRpExtensionSignature : new Uint8Array()));
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.nonRpVoteExtension = (_d = object.nonRpVoteExtension) !== null && _d !== void 0 ? _d : new Uint8Array();
        message.nonRpExtensionSignature = (_e = object.nonRpExtensionSignature) !== null && _e !== void 0 ? _e : new Uint8Array();
        return message;
    },
};
