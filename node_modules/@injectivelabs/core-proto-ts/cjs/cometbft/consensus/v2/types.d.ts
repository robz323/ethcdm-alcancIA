...
import { BlockID, Part, PartSetHeader, Proposal as Proposal1, SignedMsgType, Vote as Vote2 } from "../../types/v2/types";
export declare const protobufPackage = "cometbft.consensus.v2";
/**
