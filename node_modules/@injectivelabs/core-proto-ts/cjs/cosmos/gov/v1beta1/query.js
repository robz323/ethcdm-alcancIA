...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.Deposit = function (request, metadata) {
        return this.rpc.unary(exports.QueryDepositDesc, exports.QueryDepositRequest.fromPartial(request), metadata);
    };
    QueryClientImpl.prototype.Deposits = function (request, metadata) {
...
exports.QueryProposalsDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryProposalsResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.QueryVoteDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryVoteResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.QueryVotesDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryVotesResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.QueryDepositDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryDepositResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.QueryDepositsDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryDepositsResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
