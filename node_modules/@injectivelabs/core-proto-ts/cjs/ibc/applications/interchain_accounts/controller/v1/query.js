...
exports.QueryInterchainAccountRequest = {
    ...
    decode: function (input, length) {
        ...
        var message = createBaseQueryInterchainAccountRequest();
...
exports.QueryInterchainAccountResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryInterchainAccountResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.InterchainAccount = function (request, metadata) {
...
exports.QueryInterchainAccountDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryInterchainAccountResponse.decode(data);
