...
export declare const protobufPackage = "cometbft.privval.v1";
...
export declare const SignBytesRequest: {
    encode(message: SignBytesRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const SignBytesResponse: {
    encode(message: SignBytesResponse, writer?: _m0.Writer): _m0.Writer;
