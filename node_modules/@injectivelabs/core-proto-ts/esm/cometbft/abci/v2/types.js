...
import { ConsensusParams } from "../../types/v2/params.js";
import { blockIDFlagFromJSON, blockIDFlagToJSON } from "../../types/v2/validator.js";
...
export const VerifyVoteExtensionRequest = {
    ...
    fromPartial(object) {
        ...
        message.nonRpVoteExtension = object.nonRpVoteExtension ?? new Uint8Array();
        return message;
    },
};
...
export const ExtendVoteResponse = {
    ...
    fromPartial(object) {
        const message = createBaseExtendVoteResponse();
        message.voteExtension = object.voteExtension ?? new Uint8Array();
        message.nonRpExtension = object.nonRpExtension ?? new Uint8Array();
        return message;
    },
};
...
export const ExtendedVoteInfo = {
    ...
    fromPartial(object) {
        ...
        message.blockIdFlag = object.blockIdFlag ?? 0;
        message.nonRpVoteExtension = object.nonRpVoteExtension ?? new Uint8Array();
        message.nonRpExtensionSignature = object.nonRpExtensionSignature ?? new Uint8Array();
        return message;
    },
};
