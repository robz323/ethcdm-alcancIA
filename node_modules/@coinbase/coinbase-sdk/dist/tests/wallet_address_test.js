    ...
    describe("#faucet", () => {
        ...
        it("returns the faucet transaction", async () => {
            ...
            expect(faucetTransaction.getTransactionHash())
                .toBe(utils_1.VALID_FAUCET_TRANSACTION_MODEL.transaction.transaction_hash);
            ...
            expect(coinbase_1.Coinbase.apiClients.externalAddress.requestExternalFaucetFunds)
