...
describe("Validator", () => {
    ...
    it("should return a list of validators for ethereum holesky and eth asset", async () => {
        coinbase_1.Coinbase.apiClients.validator.listValidators = (0, utils_1.mockReturnValue)(utils_1.VALID_ACTIVE_VALIDATOR_LIST);
        ...
        expect(coinbase_1.Coinbase.apiClients.validator.listValidators).toHaveBeenCalledWith(coinbase_1.Coinbase.networks.EthereumHolesky, coinbase_1.Coinbase.assets.Eth, types_1.ValidatorStatus.ACTIVE);
    ...
    it("should return a validator for ethereum holesky and eth asset", async () => {
        coinbase_1.Coinbase.apiClients.validator.getValidator = (0, utils_1.mockReturnValue)((0, utils_1.mockEthereumValidator)("100", types_1.ValidatorStatus.EXITING, "0x123"));
        ...
        expect(coinbase_1.Coinbase.apiClients.validator.getValidator).toHaveBeenCalledWith(coinbase_1.Coinbase.networks.EthereumHolesky, coinbase_1.Coinbase.assets.Eth, "0x123");
