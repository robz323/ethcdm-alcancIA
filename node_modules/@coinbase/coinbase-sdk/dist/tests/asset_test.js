    ...
    describe(".fromModel", () => {
        ...
        describe("when the asset_id is gwei", () => {
            it("should set the decimals to 9", () => {
                ...
                expect(asset_1.Asset.fromModel(model, coinbase_1.Coinbase.assets.Gwei).decimals).toEqual(constants_1.GWEI_DECIMALS);
            });
        });
        describe("when the asset_id is wei", () => {
            it("should set the decimals to 0", () => {
                ...
                expect(asset_1.Asset.fromModel(model, coinbase_1.Coinbase.assets.Wei).decimals).toEqual(0);
            });
        });
    });
    describe("#toString", () => {
