...
describe("Wallet Class", () => {
    ...
    describe("#loadSeed", () => {
        ...
        it("raises an error when file contains different wallet data", async () => {
            ...
            await expect(seedlessWallet.loadSeed(filePath)).rejects.toThrow(errors_1.ArgumentError);
        });
        it("raises an error when the file is absent", async () => {
            await expect(seedlessWallet.loadSeed("non-file.json")).rejects.toThrow(errors_1.ArgumentError);
        });
        ...
        it("throws an error when the file is empty", async () => {
            ...
            await expect(wallet.loadSeed("invalid-file.json")).rejects.toThrow(errors_1.ArgumentError);
