...
describe("Authenticator tests", () => {
    ...
    const authenticator = new authenticator_1.CoinbaseAuthenticator(keys.name, keys.privateKey);
    let instance;
    let privateKey;
    let apiKey;
    beforeEach(() => {
        ...
        apiKey = "mockApiKey";
        instance = new authenticator_1.CoinbaseAuthenticator(privateKey, apiKey);
    ...
    it("should raise InvalidConfiguration error for invalid config", async () => {
        ...
        const authenticator = new authenticator_1.CoinbaseAuthenticator("api_key", "private_key");
