    ...
    const onMessage = (messageData, isBinary) => {
        ...
        if (isBinary) {
            ...
            if (header['Path'] == 'turn.start') {
                ...
                const result = { audioData: concatUint8Arrays(audioChunks), events: receivedEventMessages };
                removeWebSocketHandlers();
...
function indexOfByteSubsequence(sequence, subsequence) {
    function tryMatchAtOffset(offset) {
