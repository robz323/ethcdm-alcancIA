...
import { splitToFragments, splitToLines } from "../nlp/Segmentation.js";
...
export async function translateText_WebAPI(text, sourceLanguage, targetLanguage, tld = 'com') {
    const logger = new Logger();
    ...
    const sentenceEntries = innerArray[1][0][0][5];
    const translationsPairs = sentenceEntries.map((element) => {
...
export async function translateText_OldWebAPI(text, sourceLanguage, targetLanguage, tld = 'com') {
    const logger = new Logger();
    logger.start(`Prepare request`);
