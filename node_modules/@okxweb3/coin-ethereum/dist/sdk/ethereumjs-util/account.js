...
exports.privateToAddress = exports.privateToPublicRaw = exports.privateToPublic = exports.publicToAddress = exports.pubToAddress = exports.toChecksumAddress = exports.isValidAddress = void 0;
...
const privateToPublicRaw = function (privateKey) {
    (0, helpers_1.assertIsBuffer)(privateKey);
    return crypto_lib_1.signUtil.secp256k1.publicKeyCreate(privateKey, false);
};
exports.privateToPublicRaw = privateToPublicRaw;
