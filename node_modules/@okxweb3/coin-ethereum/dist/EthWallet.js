...
class EthWallet extends coin_base_1.BaseWallet {
    ...
    async signAuthorizationListItem(param) {
        ...
        const nonceBytes = nonce !== undefined ? eth.unpadBytes(eth.hexToBytes(nonce)) : new Uint8Array();
        ...
        const auth = {
            ...
            r: crypto_lib_1.base.toHex((0, index_1.unpadBuffer)(signed.r), true),
            s: crypto_lib_1.base.toHex((0, index_1.unpadBuffer)(signed.s), true),
        };
        return auth;
    }
