...
function addAddressesToTable(authority, payer, lookUpTableAddress, addressesToAdd) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2, addAddressesInstruction];
        });
    });
}
...
function getAddressesInTable(connection, lookUpTableAddress) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, connection.getAddressLookupTable(lookUpTableAddress)];
                case 1:
                    lookupTableAccount = (_a.sent());
                    if (!lookupTableAccount.value)
                        return [2];
                    return [2, lookupTableAccount.value.state.addresses];
            }
        });
    });
}
