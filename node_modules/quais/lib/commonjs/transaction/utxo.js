...
exports.UTXO = exports.denominate = exports.denominations = void 0;
...
function isValidDenominationIndex(index) {
    return index >= 0 && index < exports.denominations.length;
}
/**
...
function denominate(value, maxDenomination) {
    ...
    if (maxDenomination != null) {
        maxDenominationIndex = exports.denominations.findIndex((d) => d === maxDenomination);
        ...
        maxDenominationIndex = exports.denominations.length - 1;
    }
    ...
    for (let i = maxDenominationIndex; i >= 0; i--) {
        const denomination = exports.denominations[i];
...
class UTXO {
     ...
     */
    set address(value) {
        (0, index_js_1.validateAddress)(value);
        this.#address = value;
    }
    /**
