...
class Mnemonic {
     ...
     */
    computeSeed() {
        const salt = (0, index_js_3.toUtf8Bytes)('mnemonic' + this.password, 'NFKD');
        return (0, index_js_1.pbkdf2)((0, index_js_3.toUtf8Bytes)(this.phrase, 'NFKD'), salt, 2048, 64, 'sha512');
    }
    /**
