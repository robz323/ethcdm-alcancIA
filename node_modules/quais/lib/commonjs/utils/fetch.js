...
class FetchRequest {
    ...
    set body(body) {
        if (body == null) {
            ...
            this.#body = (0, index_js_1.toUtf8Bytes)(body);
            ...
            this.#body = (0, index_js_1.toUtf8Bytes)(JSON.stringify(body));
    ...
    get headers() {
        ...
        if (this.#creds) {
            headers['authorization'] = `Basic ${(0, base64_js_1.encodeBase64)((0, index_js_1.toUtf8Bytes)(this.#creds))}`;
        }
        if (this.allowGzip) {
...
class FetchResponse {
    ...
    get bodyText() {
        try {
            return this.#body == null ? '' : (0, index_js_1.toUtf8String)(this.#body);
        }
        catch (error) {
...
function unpercent(value) {
    return (0, index_js_1.toUtf8Bytes)(value.replace(/%([0-9a-f][0-9a-f])/gi, (all, code) => {
