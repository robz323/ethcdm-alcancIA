...
function pointAdd(a, b, compress) {
    try {
        return secp256k1_1.secp256k1.ProjectivePoint.fromHex(a).add(secp256k1_1.secp256k1.ProjectivePoint.fromHex(b)).toRawBytes(compress);
    }
    catch {
        return null;
    }
...
function pointCompress(p, compress = true) {
    return secp256k1_1.secp256k1.ProjectivePoint.fromHex(p).toRawBytes(compress);
}
function liftX(p) {
    try {
...
function taggedHash(tag, ...messages) {
    return secp256k1_1.schnorr.utils.taggedHash(tag, ...messages);
}
