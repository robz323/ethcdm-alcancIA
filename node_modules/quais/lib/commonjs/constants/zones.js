...
exports.fromZone = exports.toZone = exports.ZoneData = exports.Ledger = exports.Zone = void 0;
/**
...
function toZone(shard) {
    return zoneFromBytes(exports.ZoneData.find((it) => it.name == shard || it.byte == shard || it.nickname == shard || it.shard == shard)
        ?.byte || '');
}
exports.toZone = toZone;
function fromZone(zone, key) {
    return exports.ZoneData.find((it) => it.byte == zone)?.[key] || '';
}
