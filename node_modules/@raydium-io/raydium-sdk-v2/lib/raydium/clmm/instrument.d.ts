...
import { bI as ReturnTypeMakeInstructions, o as ApiV3PoolInfoConcentratedItem, B as ClmmKeys, i as ApiV3Token } from '../../api-bde57510.js';
import { ClmmPositionLayout } from './layout.js';
import { p as OpenPositionFromBaseExtInfo, r as OpenPositionFromLiquidityExtInfo, B as ClosePositionExtInfo, M as ManipulateLiquidityExtInfo, e as ClmmPoolPersonalPosition, E as InitRewardExtInfo, J as ClmmLockAddress } from '../../type-93dba330.js';
import 'axios';
...
declare class ClmmInstrument {
    ...
    static makeLockPositions({ programId, authProgramId, poolProgramId, payer, wallet, nftMint, getEphemeralSigners, }: {
        programId: PublicKey;
    ...
    static lockPositionInstructionV2({ programId, auth, payer, positionOwner, lockOwner, positionNftAccount, positionId, lockPositionId, lockNftMint, lockNftAccount, metadataAccount, withMetadata, }: {
        programId: PublicKey;
        auth: PublicKey;
        payer: PublicKey;
