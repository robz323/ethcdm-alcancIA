...
const FrameApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchFrameCatalog: async (limit, cursor, timeWindow, options = {}) => {
...
const FrameApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchFrameCatalog(limit, cursor, timeWindow, options) {
            var _a, _b, _c;
...
class FrameApi extends base_1.BaseAPI {
     ...
     */
    fetchFrameCatalog(requestParameters = {}, options) {
        return (0, exports.FrameApiFp)(this.configuration).fetchFrameCatalog(requestParameters.limit, requestParameters.cursor, requestParameters.timeWindow, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetches the mini app meta tags from the URL
     * @summary Meta tags from URL
