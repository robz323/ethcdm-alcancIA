...
import { NameAccountAndDomain } from './name-record-handler';
export declare class TldParser {
     ...
     * @param tld tld to be retrieved from
     */
    getParsedAllUserDomainsFromTld(userAccount: PublicKey | string, tld: string): Promise<NameAccountAndDomain[]>;
    /**
     ...
     * @param tld tld to be retrieved from
     */
    getParsedAllUserDomainsUnwrapped(userAccount: PublicKey | string): Promise<NameAccountAndDomain[]>;
    /**
     ...
     * @param tld tld to be retrieved from
     */
    getParsedAllUserDomains(userAccount: PublicKey | string): Promise<NameAccountAndDomain[]>;
}
