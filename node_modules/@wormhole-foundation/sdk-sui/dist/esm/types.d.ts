import type { MoveValue, SuiObjectResponse } from "@mysten/sui/client";
...
export declare const getFieldsFromObjectResponse: (object: SuiObjectResponse) => import("@mysten/sui/client").MoveStruct | null;
export declare const isSameType: (a: string, b: string) => boolean;
export declare const isSuiCreateEvent: <T extends import("@mysten/sui/client").SuiObjectChange, K extends Extract<T, {
    type: "created";
}>>(event: T) => event is K;
export declare const isSuiPublishEvent: <T extends import("@mysten/sui/client").SuiObjectChange, K extends Extract<T, {
    type: "published";
}>>(event: T) => event is K;
