...
exports.Cosmos_authzv1beta1Authorization_ToAmino = exports.Cosmos_authzv1beta1Authorization_FromAmino = exports.Cosmos_authzv1beta1Authorization_InterfaceDecoder = exports.GrantQueueItem = exports.GrantAuthorization = exports.Grant = exports.GenericAuthorization = void 0;
//@ts-nocheck
...
const authz_4 = require("../../../cosmwasm/wasm/v1/authz");
...
const Cosmos_authzv1beta1Authorization_InterfaceDecoder = (input) => {
    ...
    switch (data.typeUrl) {
        ...
        case "/cosmwasm.wasm.v1.StoreCodeAuthorization":
            return authz_4.StoreCodeAuthorization.decode(data.value);
        case "/cosmwasm.wasm.v1.ContractExecutionAuthorization":
            return authz_4.ContractExecutionAuthorization.decode(data.value);
        case "/cosmwasm.wasm.v1.ContractMigrationAuthorization":
            return authz_4.ContractMigrationAuthorization.decode(data.value);
        default:
            return data;
    }
};
    ...
    switch (content.type) {
        ...
        case "wasm/StoreCodeAuthorization":
            return any_1.Any.fromPartial({
                ...
                value: authz_4.StoreCodeAuthorization.encode(authz_4.StoreCodeAuthorization.fromPartial(authz_4.StoreCodeAuthorization.fromAmino(content.value))).finish()
            });
        case "wasm/ContractExecutionAuthorization":
            return any_1.Any.fromPartial({
                typeUrl: "/cosmwasm.wasm.v1.ContractExecutionAuthorization",
                value: authz_4.ContractExecutionAuthorization.encode(authz_4.ContractExecutionAuthorization.fromPartial(authz_4.ContractExecutionAuthorization.fromAmino(content.value))).finish()
            });
        case "wasm/ContractMigrationAuthorization":
            return any_1.Any.fromPartial({
                typeUrl: "/cosmwasm.wasm.v1.ContractMigrationAuthorization",
                value: authz_4.ContractMigrationAuthorization.encode(authz_4.ContractMigrationAuthorization.fromPartial(authz_4.ContractMigrationAuthorization.fromAmino(content.value))).finish()
            });
        default:
    ...
    switch (content.typeUrl) {
        ...
        case "/cosmwasm.wasm.v1.StoreCodeAuthorization":
            return {
                ...
                value: authz_4.StoreCodeAuthorization.toAmino(authz_4.StoreCodeAuthorization.decode(content.value, undefined))
            };
        case "/cosmwasm.wasm.v1.ContractExecutionAuthorization":
            return {
                type: "wasm/ContractExecutionAuthorization",
                value: authz_4.ContractExecutionAuthorization.toAmino(authz_4.ContractExecutionAuthorization.decode(content.value, undefined))
            };
        case "/cosmwasm.wasm.v1.ContractMigrationAuthorization":
            return {
                type: "wasm/ContractMigrationAuthorization",
                value: authz_4.ContractMigrationAuthorization.toAmino(authz_4.ContractMigrationAuthorization.decode(content.value, undefined))
            };
        default:
