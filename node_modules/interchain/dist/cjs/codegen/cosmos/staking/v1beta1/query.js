...
exports.QueryHistoricalInfoResponse = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.historicalRecord !== undefined) {
            staking_1.HistoricalRecord.encode(message.historicalRecord, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.historicalRecord = object.historicalRecord !== undefined && object.historicalRecord !== null ? staking_1.HistoricalRecord.fromPartial(object.historicalRecord) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseQueryHistoricalInfoResponse();
        ...
        if (object.historical_record !== undefined && object.historical_record !== null) {
            message.historicalRecord = staking_1.HistoricalRecord.fromAmino(object.historical_record);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.historical_record = message.historicalRecord ? staking_1.HistoricalRecord.toAmino(message.historicalRecord) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
