...
exports.HistoricalRecord = {
    ...
    fromAmino(object) {
        ...
        if (object.apphash !== undefined && object.apphash !== null) {
            message.apphash = (0, helpers_1.bytesFromBase64)(object.apphash);
        }
    ...
    toAmino(message) {
        const obj = {};
        obj.apphash = message.apphash ? (0, helpers_1.base64FromBytes)(message.apphash) : undefined;
    ...
    fromAminoMsg(object) {
        return exports.HistoricalRecord.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/HistoricalRecord",
            value: exports.HistoricalRecord.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.HistoricalRecord.decode(message.value);
    },
    toProto(message) {
        return exports.HistoricalRecord.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.staking.v1beta1.HistoricalRecord",
            value: exports.HistoricalRecord.encode(message).finish()
        };
    }
};
