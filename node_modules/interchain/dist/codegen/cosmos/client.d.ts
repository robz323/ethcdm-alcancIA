...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.bank.v1beta1.MsgBurn": {
        aminoType: string;
        toAmino: (message: import("./bank/v1beta1/tx").MsgBurn) => import("./bank/v1beta1/tx").MsgBurnAmino;
        fromAmino: (object: import("./bank/v1beta1/tx").MsgBurnAmino) => import("./bank/v1beta1/tx").MsgBurn;
    };
    ...
    "/cosmos.accounts.v1.MsgInit": {
        aminoType: string;
        toAmino: (message: import("./accounts/v1/tx").MsgInit) => import("./accounts/v1/tx").MsgInitAmino;
        fromAmino: (object: import("./accounts/v1/tx").MsgInitAmino) => import("./accounts/v1/tx").MsgInit;
    };
    "/cosmos.accounts.v1.MsgExecute": {
        aminoType: string;
        toAmino: (message: import("./accounts/v1/tx").MsgExecute) => import("./accounts/v1/tx").MsgExecuteAmino;
        fromAmino: (object: import("./accounts/v1/tx").MsgExecuteAmino) => import("./accounts/v1/tx").MsgExecute;
    };
};
