...
export class LCDQueryClient {
    ...
    groupPoliciesByGroup = async (params) => {
        const options = {
            params: {}
        };
        if (typeof params?.pagination !== "undefined") {
    ...
    groupPoliciesByAdmin = async (params) => {
        const options = {
            params: {}
        };
        if (typeof params?.pagination !== "undefined") {
    ...
    proposalsByGroupPolicy = async (params) => {
        const options = {
            params: {}
        };
        if (typeof params?.pagination !== "undefined") {
