...
exports.basicCoins = [
    ...
    {
        key: types_1.CoinKey.POL,
        name: types_1.CoinKey.POL,
        logoURI: 'https://static.debank.com/image/matic_token/logo_url/matic/6f5a6b6f0732a7a235131bd7804d357c.png',
        verified: true,
        chains: {
            [types_1.ChainId.ETH]: {
    ...
    {
        key: types_1.CoinKey.WSOL,
        name: types_1.CoinKey.WSOL,
    ...
    {
        key: types_1.CoinKey.G,
        name: types_1.CoinKey.G,
    ...
    {
        key: types_1.CoinKey.IMX,
        name: types_1.CoinKey.IMX,
    ...
    {
        key: types_1.CoinKey.KLAY,
        name: types_1.CoinKey.KLAY,
    ...
    {
        key: types_1.CoinKey.OKB,
        name: types_1.CoinKey.OKB,
    ...
    {
        key: types_1.CoinKey.WBNB,
        name: types_1.CoinKey.WBNB,
    ...
    {
        key: types_1.CoinKey.FDUSD,
        name: types_1.CoinKey.FDUSD,
        logoURI: 'https://static.debank.com/image/eth_token/logo_url/0xc5f0f7b66764f6ec8c8dff7ba683102295e16409/9c61b134f82d8780005895d8fb6b19ab.png',
        verified: true,
        chains: {
            [types_1.ChainId.ETH]: {
...
exports.wrappedTokens = {
    ...
    [types_1.ChainId.GRA]: {
        ...
        symbol: 'WG',
        decimals: 18,
        chainId: types_1.ChainId.GRA,
        coinKey: types_1.CoinKey.WG,
        name: 'Wrapped G',
        logoURI: 'https://assets.gravity.xyz/token_logo.png',
    },
    [types_1.ChainId.IMX]: {
        ...
        symbol: 'WIMX',
        decimals: 18,
        chainId: types_1.ChainId.IMX,
        coinKey: types_1.CoinKey.WIMX,
        name: 'Wrapped IMX',
        logoURI: 'https://static.debank.com/image/eth_token/logo_url/0xf57e7e7c23978c3caec3c3548e3d615c346e79ff/7a875818146ec0508d3e5f5b14f1b4eb.png',
    },
    [types_1.ChainId.KAI]: {
        ...
        symbol: 'WKLAY',
        decimals: 18,
        chainId: types_1.ChainId.KAI,
        coinKey: types_1.CoinKey.WKLAY,
        name: 'Wrapped KLAY',
        logoURI: 'https://static.debank.com/image/klay_token/logo_url/0x19aac5f612f524b754ca7e7c41cbfa2e981a4432/1866fc790849a903e0594ce0f55b758d.png',
    },
    [types_1.ChainId.XLY]: {
        ...
        symbol: 'WOKB',
        decimals: 18,
        chainId: types_1.ChainId.XLY,
        coinKey: types_1.CoinKey.WOKB,
        name: 'Wrapped OKB',
        logoURI: 'https://static.debank.com/image/xlayer_token/logo_url/0xe538905cf8410324e03a5a23c1c177a474d59b2b/b58d6980429c56560d9241765bdf9c2b.png',
    },
    [types_1.ChainId.OPB]: {
        ...
        symbol: 'WBNB',
        decimals: 18,
        chainId: types_1.ChainId.OPB,
        coinKey: types_1.CoinKey.WBNB,
        name: 'Wrapped BNB',
        logoURI: 'https://static.debank.com/image/bsc_token/logo_url/0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c/1177dec1b9b7f58a799c3f22d93b04e1.png',
    },
};
...
const findTokenByChainIdAndAddress = (chainId, tokenAddress) => {
    return (exports.defaultCoins
        .flatMap(({ chains }) => Object.values(chains))
        .find((token) => token.chainId === chainId &&
        tokenAddress.toLowerCase() === token.address.toLowerCase()) ?? null);
};
