...
describe.concurrent('SVM chains RPC check', () => {
    const rpcUrls = supportedSolanaChains.flatMap((chain) => chain.metamask.rpcUrls.map((rpcUrl) => ({
        rpcUrl: rpcUrl,
        chainId: chain.id,
...
describe.concurrent('SVM chains block explorer check', () => {
    const blockExplorerUrls = supportedSolanaChains.flatMap((chain) => chain.metamask.blockExplorerUrls.map((blockExplorerUrl) => ({
