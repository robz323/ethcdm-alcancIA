 ...
 * @category generated
 */
export declare class GlobalCleanupLog implements GlobalCleanupLogArgs {
     ...
     */
    static fromArgs(args: GlobalCleanupLogArgs): GlobalCleanupLog;
    /**
     * Deserializes the {@link GlobalCleanupLog} from the data of the provided {@link web3.AccountInfo}.
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    static fromAccountInfo(accountInfo: web3.AccountInfo<Buffer>, offset?: number): [GlobalCleanupLog, number];
    /**
     ...
     */
    static fromAccountAddress(connection: web3.Connection, address: web3.PublicKey, commitmentOrConfig?: web3.Commitment | web3.GetAccountInfoConfig): Promise<GlobalCleanupLog>;
    /**
     ...
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    static deserialize(buf: Buffer, offset?: number): [GlobalCleanupLog, number];
    /**
 ...
 * @category generated
 */
export declare const globalCleanupLogBeet: beet.BeetStruct<GlobalCleanupLog, GlobalCleanupLogArgs>;
//# sourceMappingURL=GlobalCleanupLog.d.ts.map