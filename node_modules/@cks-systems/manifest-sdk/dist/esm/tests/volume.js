...
async function testVolume() {
    ...
    await placeOrder(connection, payerKeypair, marketAddress, 1, 1, true, OrderType.Limit, 0);
    await placeOrder(connection, payerKeypair, marketAddress, 1, 1, false, OrderType.Limit, 1);
    ...
    const marketInfoParsed = wrapper.marketInfoForMarket(marketAddress);
    // 2 because self trade.
    assert(Number(marketInfoParsed.quoteVolumeAtoms) == 2_000_000, 'quote volume on wrapper');
}
