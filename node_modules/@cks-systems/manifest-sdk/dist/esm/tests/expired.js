...
async function testExpiredAsk() {
    ...
    await placeOrder(connection, payerKeypair, marketAddress, 5, 5, false, OrderType.Limit, 0, (await connection.getSlot()) + 20);
...
async function testExpiredBid() {
    ...
    await placeOrder(connection, payerKeypair, marketAddress, 1, 1, true, OrderType.Limit, 0, (await connection.getSlot()) + 20);
    await market.reload(connection);
    market.prettyPrint();
