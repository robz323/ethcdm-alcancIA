...
const stake_for_fee_1 = require("@meteora-ag/stake-for-fee");
...
const createProgram = (connection, programId) => {
    ...
    const stakeForFeeProgram = new anchor_1.Program(stake_for_fee_1.IDL, stake_for_fee_1.STAKE_FOR_FEE_PROGRAM_ID, provider);
