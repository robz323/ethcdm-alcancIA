...
var _dynamicammsdk = require('@mercurial-finance/dynamic-amm-sdk'); var _dynamicammsdk2 = _interopRequireDefault(_dynamicammsdk);
...
var AlphaVault = class {
  ...
  static async create(connection, vaultAddress, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _ => _.cluster]) || "mainnet-beta"],
      provider
    );
  ...
  static async createCustomizableFcfsVault(connection, vaultParam, owner, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _2 => _2.cluster]) || "mainnet-beta"],
      provider
    );
    const {
      poolAddress,
  ...
  static async createCustomizableProrataVault(connection, vaultParam, owner, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _3 => _3.cluster]) || "mainnet-beta"],
      provider
    );
    const {
      poolAddress,
  ...
  static async createPermissionlessVault(connection, vaultParam, owner, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _4 => _4.cluster]) || "mainnet-beta"],
      provider
    );
  ...
  static async createPermissionedVaultWithMerkleProof(connection, vaultParam, owner, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _5 => _5.cluster]) || "mainnet-beta"],
      provider
    );
  ...
  static async createPermissionedVaultWithAuthorityFund(connection, vaultParam, owner, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _6 => _6.cluster]) || "mainnet-beta"],
      provider
    );
    return AlphaVault.createVault(
      program,
  ...
  static async getFcfsConfigs(connection, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _7 => _7.cluster]) || "mainnet-beta"],
      provider
    );
  ...
  static async getProrataConfigs(connection, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _8 => _8.cluster]) || "mainnet-beta"],
      provider
    );
  ...
  static async getEscrowByOwner(connection, owner, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _9 => _9.cluster]) || "mainnet-beta"],
      provider
    );
  ...
  static async getVault(connection, vaultAddress, opt) {
    ...
    const program = new (0, _anchor.Program)(
      IDL,
      PROGRAM_ID[_optionalChain([opt, 'optionalAccess', _10 => _10.cluster]) || "mainnet-beta"],
      provider
    );
...
exports.ALPHA_VAULT_TREASURY_ID = ALPHA_VAULT_TREASURY_ID; exports.ActivationType = ActivationType; exports.DLMM_PROGRAM_ID = DLMM_PROGRAM_ID; exports.DYNAMIC_AMM_PROGRAM_ID = DYNAMIC_AMM_PROGRAM_ID; exports.IDL = IDL; exports.MERKLE_PROOF_API = MERKLE_PROOF_API; exports.PROGRAM_ID = PROGRAM_ID; exports.PermissionWithAuthority = PermissionWithAuthority; exports.PermissionWithMerkleProof = PermissionWithMerkleProof; exports.Permissionless = Permissionless; exports.PoolType = PoolType; exports.SEED = SEED; exports.VAULT_PROGRAM_ID = VAULT_PROGRAM_ID; exports.VaultMode = VaultMode; exports.default = src_default;
