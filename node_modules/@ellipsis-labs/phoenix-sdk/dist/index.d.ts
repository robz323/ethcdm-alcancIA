...
import { PublicKey, Connection, TransactionInstruction, Transaction, TransactionSignature, ParsedTransactionWithMeta, TokenAmount, AccountInfo } from '@solana/web3.js';
...
declare class Market {
    ...
    baseToken?: Token;
    quoteToken?: Token;
    constructor({ name, address, baseToken, quoteToken, data, }: {
        address: PublicKey;
        data: MarketData;
        name?: string;
        baseToken?: Token;
     ...
     */
    static load({ address, buffer, tokenList, }: {
        address: PublicKey;
        buffer: Buffer;
 ...
 * @param levels The number of book levels to return, -1 to return the entire book
 */
declare function getMarketLadder(market: Market, slot: beet.bignum, unixTimestamp: beet.bignum, levels?: number): Ladder;
/**
 * Converts a ladder level from BN to JS number representation
 *
 ...
 */
declare function levelToUiLevel(market: Market, priceInTicks: number, sizeInBaseLots: number): UiLadderLevel;
/**
 * Returns the ladder of bids and asks as JS numbers for given `MarketData`
 *
 ...
 * @param levels The number of book levels to return
 */
declare function getMarketUiLadder(market: Market, levels?: number, slot?: beet.bignum, unixTimestamp?: beet.bignum): UiLadder;
/**
 ...
 * @returns
 */
declare function getMakerSetupInstructionsForMarket(connection: Connection, market: Market, trader: PublicKey): Promise<TransactionInstruction[]>;
/**
 ...
 * @returns
 */
declare function getLimitOrderNewMakerIxs(connection: Connection, market: Market, trader: PublicKey, orderPacket: OrderPacket): Promise<TransactionInstruction[]>;
/**
 ...
 * @returns
 */
declare function getLimitOrderUnknownSeatIxs(connection: Connection, market: Market, trader: PublicKey, orderPacket: OrderPacket): Promise<TransactionInstruction[]>;
 ...
 */
declare function getEvictSeatIx(market: Market, trader: PublicKey, signer: PublicKey, baseTokenAccountBackup?: PublicKey, quoteTokenAccountBackup?: PublicKey): TransactionInstruction;
/**
 ...
 * @param trader The trader's address
 */
declare function confirmOrCreateClaimSeatIxs(connection: Connection, market: Market, trader: PublicKey): Promise<TransactionInstruction[]>;
/**
 * Checks if the given trader has a seat on the given market
 * If not, return claim seat instructions
 * @param connection An instance of the Connection class
 ...
 * @param trader The trader's address
 */
declare function createClaimSeatInstructions(connection: Connection, market: Market, trader: PublicKey): Promise<TransactionInstruction[]>;
/**
 ...
 * @returns
 */
declare function findTraderToEvict(connection: Connection, market: Market): Promise<PublicKey | void>;
...
declare class Client {
    ...
    clock: ClockData;
    private constructor();
    static loadMarketsAndTokens(marketKeysAndData: Array<[PublicKey, AccountInfo<Buffer>]>, tokenConfig: Array<TokenConfig>): [Map<string, Market>, Token[]];
    /**
     ...
     */
    static create(connection: Connection, endpoint: string, trader?: PublicKey): Promise<Client>;
    static createWithoutConfig(connection: Connection, marketAddresses: PublicKey[], trader?: PublicKey): Promise<Client>;
    static createWithMarketAddresses(connection: Connection, endpoint: string, marketAddresses: PublicKey[], trader?: PublicKey): Promise<Client>;
    /**
     ...
     *
     */
    addMarket(marketAddress: string, forceReload?: boolean): Promise<void>;
    /**
     ...
     */
    refreshMarket(marketAddress: string | PublicKey): Promise<Market>;
...
declare class PostOnlyOrderTemplate {
    side: Side;
    priceAsFloat: number;
...
declare class LimitOrderTemplate {
    side: Side;
    priceAsFloat: number;
    sizeInBaseUnits: number;
    selfTradeBehavior: SelfTradeBehavior;
...
declare class ImmediateOrCancelOrderTemplate {
    side: Side;
    priceAsFloat: number;
    sizeInBaseUnits: number;
 ...
 */
declare function getPostOnlyOrderPacket({ side, priceInTicks, numBaseLots, rejectPostOnly, clientOrderId, useOnlyDepositedFunds, lastValidSlot, lastValidUnixTimestampInSeconds, }: {
    side: Side;
    priceInTicks: number;
    numBaseLots: number;
    rejectPostOnly?: boolean;
 ...
 * @param lastValidUnixTimestampInSeconds The last valid unix timestamp in seconds for a time in force order
 */
declare function getLimitOrderPacket({ side, priceInTicks, numBaseLots, selfTradeBehavior, matchLimit, clientOrderId, useOnlyDepositedFunds, lastValidSlot, lastValidUnixTimestampInSeconds, }: {
    side: Side;
    priceInTicks: number;
    numBaseLots: number;
    selfTradeBehavior?: SelfTradeBehavior;
