...
import { MintsSortBy, RaritySystem } from './types';
export const getMintRank = (sortBy, ranks) => {
    switch (sortBy) {
...
export const getSortSign = (sortBy) => {
    switch (sortBy) {
...
export const makeMintsSortFn = (sortBy) => {
    ...
    return (a, b) => {
        switch (sortBy) {
            ...
            case MintsSortBy.PriceDesc:
                return (sign *
                    sortNumberOrBig(a.grossAmount ? new Big(a.grossAmount) : null, b.grossAmount ? new Big(b.grossAmount) : null, nullsFirst));
            case MintsSortBy.LastSaleAsc:
            case MintsSortBy.LastSaleDesc:
                return (sign *
                    sortNumberOrBig(a.lastSale ? new Big(a.lastSale) : null, b.lastSale ? new Big(b.lastSale) : null, nullsFirst));
            case MintsSortBy.ListedDesc:
                return sign * (a.txAt - b.txAt);
            case MintsSortBy.OrdinalAsc:
            case MintsSortBy.OrdinalDesc:
                return (sign *
                    sortBigInt(a.ordinal ? BigInt(a.ordinal) : null, b.ordinal ? BigInt(b.ordinal) : null, nullsFirst));
            case MintsSortBy.NormalizedPriceAsc:
            case MintsSortBy.NormalizedPriceDesc:
                return (sign *
                    sortNumberOrBig(a.normalizedPrice ? new Big(a.normalizedPrice) : null, b.normalizedPrice ? new Big(b.normalizedPrice) : null, nullsFirst));
            case MintsSortBy.HybridAmountAsc:
            case MintsSortBy.HybridAmountDesc:
                return (sign *
                    sortNumberOrBig(a.hybridAmount ? new Big(a.hybridAmount) : null, b.hybridAmount ? new Big(b.hybridAmount) : null, nullsFirst));
            // NB: need default in case divergence b/w FE & BE.
            default:
                return (sign *
                    sortNumberOrBig(getMintRank(sortBy, a.ranks), getMintRank(sortBy, b.ranks), nullsFirst));
        }
    };
};
