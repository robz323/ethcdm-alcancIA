...
import { ComputeBudgetProgram, PublicKey, SYSVAR_INSTRUCTIONS_PUBKEY, SYSVAR_RENT_PUBKEY, SYSVAR_SLOT_HASHES_PUBKEY, SystemProgram, } from '@solana/web3.js';
import { AUTH_PROGRAM_ID, BUBBLEGUM_PROGRAM_ID, CANDY_GUARD_PROGRAM_ID, CANDY_V3_PROGRAM_ID, TMETA_PROGRAM_ID, } from '../metaplex';
import { BROKER_ADDRS, CURRENCY_ADDRS, SWAPSORIAN_PROGRAM_ID, TBID_PROGRAM_ID, TCOMP_PROGRAM_ID, TCOMP_TRAIT_BID_COSIGNER, TDROP_PROGRAM_ID, TGARD_PROGRAM_ID, TLIST_PROGRAM_ID, TLOCK_PDA_ADDR, TLOCK_PROGRAM_ID, TROLL_COSIGNER_ADDR, TROLL_PROGRAM_ID, TROLL_TREASURY_ADDR, TROLL_WITHDRAW_COSIGNER_ADDR, TSTKE_PROGRAM_ID, TSWAP_PDA_ADDR, TSWAP_PROGRAM_ID, } from './constants';
...
const BROKER_CURRENCY_ATAS = BROKER_ADDRS.flatMap((broker) => CURRENCY_ADDRS.map((currency) => findAta(currency, broker)));
export const TENSOR_LUT_STORED_ADDRS = [
    //compression
    SPL_NOOP_PROGRAM_ID,
