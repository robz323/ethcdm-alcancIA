 ...
 */
import { AuctionHouse, createCancelInstruction, createWithdrawInstruction, } from '@metaplex-foundation/mpl-auction-house';
import { PublicKey, } from '@solana/web3.js';
import BN from 'bn.js';
import { findAuctionHouseBuyerEscrowPda, findAuctionHouseTradeStatePda, } from '../../metaplex';
import { buildTx } from '../../solana_contrib';
import { getQuantityWithMantissa } from './shared';
export const makeAHCancelBidTx = async (connections, tokenMint, walletOwner, //either nft owner (for delisting) or bidder (for bid cancellation)
auctionHouse, priceLamports, totalWithdrawLamports, cancelBid = false, tokenSize = 1) => {
    ...
    const [tradeState] = findAuctionHouseTradeStatePda(auctionHouseKey, ownerKey, auctionHouseObj.treasuryMint, mintKey, priceLamports, tokenSizeAdjusted, tokenAccountKey);
