...
export const findTokenRecordPda = (mint, token) => {
...
export const findRuleSetPda = (payer, name) => {
    return PublicKey.findProgramAddressSync([Buffer.from('rule_set'), payer.toBuffer(), Buffer.from(name)], AUTH_PROGRAM_ID);
};
