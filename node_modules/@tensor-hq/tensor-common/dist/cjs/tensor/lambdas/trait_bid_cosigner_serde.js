...
exports.TraitBidRequestType = exports.deserializePlaceBidArgs = exports.serializePlaceBidArgs = exports.deserializeTakeNonCompressedArgs = exports.serializeTakeNonCompressedArgs = exports.deserializeTakeCompressedArgs = exports.serializeTakeCompressedArgs = void 0;
...
function deserializeInstruction(serialized) {
    return {
        programId: new web3_js_1.PublicKey(serialized.programId),
        keys: serialized.keys.map((keyObj) => ({
            pubkey: new web3_js_1.PublicKey(keyObj.pubkey),
            isSigner: keyObj.isSigner,
            isWritable: keyObj.isWritable,
        })),
...
function deserializeMetadataArgs(serialized) {
    return {
        ...
        collection: serialized.collection
            ? {
                key: new web3_js_1.PublicKey(serialized.collection.key),
        ...
        uses: serialized.uses
            ? {
                ...
                remaining: new bn_js_1.default(serialized.uses.remaining),
                total: new bn_js_1.default(serialized.uses.total),
            }
            : null,
    };
}
function serializeTakeCompressedArgs(args) {
    return {
...
exports.serializeTakeCompressedArgs = serializeTakeCompressedArgs;
function deserializeTakeCompressedArgs(args) {
    return {
        targetData: args.targetData.target === 'assetIdOrFvcWithoutField'
            ? {
                target: args.targetData.target,
        ...
        bidId: new web3_js_1.PublicKey(args.bidId),
        merkleTree: new web3_js_1.PublicKey(args.merkleTree),
        proof: args.proof.map((p) => Buffer.from(p)),
        root: args.root,
        nonce: args.nonce ? new bn_js_1.default(args.nonce) : undefined,
        index: args.index,
        minAmount: new bn_js_1.default(args.minAmount),
        currency: args.currency ? new web3_js_1.PublicKey(args.currency) : null,
        makerBroker: args.makerBroker ? new web3_js_1.PublicKey(args.makerBroker) : null,
        optionalRoyaltyPct: args.optionalRoyaltyPct,
        owner: new web3_js_1.PublicKey(args.owner),
        seller: new web3_js_1.PublicKey(args.seller),
        delegate: args.delegate ? new web3_js_1.PublicKey(args.delegate) : undefined,
        margin: args.margin ? new web3_js_1.PublicKey(args.margin) : null,
        takerBroker: args.takerBroker ? new web3_js_1.PublicKey(args.takerBroker) : null,
        rentDest: new web3_js_1.PublicKey(args.rentDest),
        compute: args.compute,
        priorityMicroLamports: args.priorityMicroLamports,
        canopyDepth: args.canopyDepth,
        whitelist: args.whitelist ? new web3_js_1.PublicKey(args.whitelist) : null,
        delegateSigner: args.delegateSigner,
        cosigner: args.cosigner ? new web3_js_1.PublicKey(args.cosigner) : null,
        feePayer: args.feePayer ? new web3_js_1.PublicKey(args.feePayer) : null,
        blockhash: args.blockhash,
        extMeta: args.extMeta,
    };
}
exports.deserializeTakeCompressedArgs = deserializeTakeCompressedArgs;
function serializeTakeNonCompressedArgs(args) {
    return {
        bidId: args.bidId.toString(),
...
exports.serializeTakeNonCompressedArgs = serializeTakeNonCompressedArgs;
function deserializeTakeNonCompressedArgs(args) {
    return {
        bidId: new web3_js_1.PublicKey(args.bidId),
        nftMint: new web3_js_1.PublicKey(args.nftMint),
        nftSellerAcc: new web3_js_1.PublicKey(args.nftSellerAcc),
        owner: new web3_js_1.PublicKey(args.owner),
        seller: new web3_js_1.PublicKey(args.seller),
        minAmount: new bn_js_1.default(args.minAmount),
        currency: args.currency ? new web3_js_1.PublicKey(args.currency) : null,
...
exports.deserializeTakeNonCompressedArgs = deserializeTakeNonCompressedArgs;
function serializePlaceBidArgs(args) {
    return {
        traits: args.traits,
...
exports.serializePlaceBidArgs = serializePlaceBidArgs;
function deserializePlaceBidArgs(serialized) {
    return {
        traits: serialized.traits,
        otherIxs: serialized.otherIxs.map(deserializeInstruction),
        target: serialized.target,
        targetId: new web3_js_1.PublicKey(serialized.targetId),
        bidId: new web3_js_1.PublicKey(serialized.bidId),
        field: serialized.field,
        fieldId: serialized.fieldId ? new web3_js_1.PublicKey(serialized.fieldId) : null,
        quantity: serialized.quantity,
        owner: new web3_js_1.PublicKey(serialized.owner),
        amount: new bn_js_1.default(serialized.amount),
        expireInSec: serialized.expireInSec ? new bn_js_1.default(serialized.expireInSec) : null,
        currency: serialized.currency ? new web3_js_1.PublicKey(serialized.currency) : null,
        makerBroker: serialized.makerBroker
            ? new web3_js_1.PublicKey(serialized.makerBroker)
            : null,
        privateTaker: serialized.privateTaker
            ? new web3_js_1.PublicKey(serialized.privateTaker)
            : null,
        compute: serialized.compute,
        priorityMicroLamports: serialized.priorityMicroLamports,
        margin: serialized.margin ? new web3_js_1.PublicKey(serialized.margin) : null,
        cosigner: serialized.cosigner ? new web3_js_1.PublicKey(serialized.cosigner) : null,
        blockhash: serialized.blockhash,
    };
}
exports.deserializePlaceBidArgs = deserializePlaceBidArgs;
var TraitBidRequestType;
...
})(TraitBidRequestType = exports.TraitBidRequestType || (exports.TraitBidRequestType = {}));
