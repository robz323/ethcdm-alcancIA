...
exports.stringifyPKsAndBNs = void 0;
const bn_js_1 = __importDefault(require("bn.js"));
const stringifyPKsAndBNs = (i) => {
    if (_isPk(i)) {
        return i.toBase58();
    }
    else if (i instanceof bn_js_1.default) {
        return i.toString();
    }
...
const _stringifyPKsAndBNsInObject = (o) => {
    ...
    for (const [k, v] of Object.entries(newO)) {
        ...
        else if (v instanceof bn_js_1.default) {
            newO[k] = v.toString();
        }
...
const _stringifyPKsAndBNInArray = (a) => {
    ...
    for (const i of a) {
        if (_isPk(i)) {
            ...
            newA.push((0, exports.stringifyPKsAndBNs)(i));
        }
        else {
            newA.push(i);
        }
