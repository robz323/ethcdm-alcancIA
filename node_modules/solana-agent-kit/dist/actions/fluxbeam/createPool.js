...
const fluxbeamCreatePoolAction = {
  ...
  Specify the token addresses and initial amounts to provide liquidity.`,
        ...
        [
            {
                ...
                output: {
                    ...
                    transaction: "4KvgJ5vVZxUxefDGqzqkVLHzHxVTyYH9StYyHKgvHYmXJgqJKxEqy9k4Rz9LpXrHF9kUZB7",
                    token_a: "SOL",
                    token_a_amount: 5,
    ...
    schema: zod_1.z.object({
        ...
        tokenAamount: zod_1.z.number().positive("Token A amount must be positive"),
        tokenB: zod_1.z.string(),
        tokenBamount: zod_1.z.number().positive("Token B amount must be positive"),
    }),
    handler: async (agent, input) => {
        try {
            const txSignature = await (0, tools_1.fluxBeamCreatePool)(agent, new web3_js_1.PublicKey(input.tokenA), input.token_a_amount, new web3_js_1.PublicKey(input.tokenB), input.token_b_amount);
            return {
                status: "success",
                message: "Pool created successfully on FluxBeam",
                tx: txSignature,
...
exports.default = fluxbeamCreatePoolAction;
