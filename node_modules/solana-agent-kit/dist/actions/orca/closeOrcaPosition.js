...
const closeOrcaPositionAction = {
    ...
    schema: zod_1.z.object({
        positionMintAddress: zod_1.z
            .string()
            .describe("The mint address of the liquidity position to close"),
    }),
    handler: async (agent, input) => {
        try {
            const signature = await (0, tools_1.orcaClosePosition)(agent, new web3_js_1.PublicKey(input.positionMintAddress));
            return {
                status: "success",
                signature,
                message: "Successfully closed Orca whirlpool position",
...
//# sourceMappingURL=closeOrcaPosition.js.map