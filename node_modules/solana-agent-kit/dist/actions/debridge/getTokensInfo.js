...
const getTokensInfo_1 = require("../../tools/debridge/getTokensInfo");
const types_1 = require("../../types");
const getDebridgeTokensInfoAction = {
    ...
    schema: types_1.getDebridgeTokensInfoSchema,
    handler: async (_agent, input) => {
        try {
            const response = await (0, getTokensInfo_1.getDebridgeTokensInfo)({
...
exports.default = getDebridgeTokensInfoAction;
//# sourceMappingURL=getTokensInfo.js.map