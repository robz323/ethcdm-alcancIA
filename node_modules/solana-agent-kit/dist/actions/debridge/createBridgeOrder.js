...
const createBridgeOrder_1 = require("../../tools/debridge/createBridgeOrder");
const createDebridgeBridgeOrderAction = {
    ...
    schema: zod_1.z.object({
        srcChainId: zod_1.z.string().describe("Source chain ID (e.g., '1' for Ethereum)"),
        srcChainTokenIn: zod_1.z
            .string()
            .describe("Source token address (use '0x0000000000000000000000000000000000000000' for native tokens on EVM)"),
        srcChainTokenInAmount: zod_1.z
            .string()
            .describe("Amount of source tokens to bridge (in smallest units)"),
        dstChainId: zod_1.z
            .string()
            .describe("Destination chain ID (e.g., '7565164' for Solana)"),
        dstChainTokenOut: zod_1.z.string().describe("Destination token address"),
        dstChainTokenOutRecipient: zod_1.z
            .string()
            .describe("Required: Recipient address on destination chain"),
        dstChainTokenOutAmount: zod_1.z
            .string()
            .optional()
            .describe("Optional: Expected amount of tokens to receive (default: 'auto')"),
        slippage: zod_1.z
            .number()
            .optional()
            .describe("Optional: Slippage tolerance in percentage (e.g., 0.5 for 0.5%)"),
        additionalTakerRewardBps: zod_1.z
            .number()
            .optional()
            .describe("Optional: Additional taker reward in basis points"),
        srcIntermediaryTokenAddress: zod_1.z
            .string()
            .optional()
            .describe("Optional: Source chain intermediary token address"),
        dstIntermediaryTokenAddress: zod_1.z
            .string()
            .optional()
            .describe("Optional: Destination chain intermediary token address"),
        dstIntermediaryTokenSpenderAddress: zod_1.z
            .string()
            .optional()
            .describe("Optional: Destination chain intermediary token spender address"),
        intermediaryTokenUSDPrice: zod_1.z
            .number()
            .optional()
            .describe("Optional: USD price of intermediary token"),
        srcAllowedCancelBeneficiary: zod_1.z
            .string()
            .optional()
    ...
    handler: async (agent, input) => {
        try {
            ...
            const response = await (0, createBridgeOrder_1.createDebridgeBridgeOrder)({
...
exports.default = createDebridgeBridgeOrderAction;
//# sourceMappingURL=createBridgeOrder.js.map