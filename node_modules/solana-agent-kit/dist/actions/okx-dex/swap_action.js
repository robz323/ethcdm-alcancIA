...
const okxDexSwapAction = {
    ...
    schema: zod_1.z.object({
        fromToken: zod_1.z.string().describe("Source token symbol or address"),
        toToken: zod_1.z.string().describe("Target token symbol or address"),
        amount: zod_1.z.number().describe("Amount to swap"),
        slippage: zod_1.z
            .string()
            .optional()
    ...
    handler: async (agent, input) => {
        ...
        // Get quote
        const quote = await (0, okx_dex_1.getQuote)(agent, fromTokenAddress, toTokenAddress, baseUnits.toString(), slippage);
        // Execute swap
        const swapResult = await (0, okx_dex_1.executeSwap)(agent, fromTokenAddress, toTokenAddress, baseUnits.toString(), slippage);
        return {
            status: "success",
            summary: {
...
exports.default = okxDexSwapAction;
//# sourceMappingURL=swap_action.js.map