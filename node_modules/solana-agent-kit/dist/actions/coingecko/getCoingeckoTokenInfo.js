...
const getCoingeckoTokenInfoAction = {
    ...
    schema: zod_1.z.object({
        tokenAddress: zod_1.z.string().nonempty(),
    }),
    handler: async (agent, input) => {
        try {
            const tokenInfo = await agent.getTokenInfoUsingCoingecko(input.tokenAddress);
            return {
                status: "success",
                result: tokenInfo,
            };
...
exports.default = getCoingeckoTokenInfoAction;
//# sourceMappingURL=getCoingeckoTokenInfo.js.map