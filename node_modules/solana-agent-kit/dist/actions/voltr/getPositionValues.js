...
const getVoltrPositionValuesAction = {
    ...
    description: "Get the current position values and total assets for a Voltr vault",
    examples: [
        [
            {
                input: {
                ...
                explanation: "Get position values for a Voltr vault showing total value and value per strategy",
            },
        ],
    ],
...
exports.default = getVoltrPositionValuesAction;
//# sourceMappingURL=getPositionValues.js.map