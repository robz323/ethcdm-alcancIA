...
const depositVoltrStrategyAction = {
    ...
    schema: zod_1.z.object({
        ...
        vault: zod_1.z
            .string()
            .min(1)
            .describe("The public key of the Voltr source vault to take assets from, e.g., 'Ga27...'"),
        strategy: zod_1.z
            .string()
            .min(1)
            .describe("The public key of the initialized target strategy to deposit into, e.g., 'Jheh...'"),
    }),
    handler: async (agent, input) => {
        try {
            const depositAmount = new bn_js_1.BN(input.depositAmount);
            const vault = new web3_js_1.PublicKey(input.vault);
            const strategy = new web3_js_1.PublicKey(input.strategy);
            const signature = await agent.voltrDepositStrategy(depositAmount, vault, strategy);
            return {
                status: "success",
...
exports.default = depositVoltrStrategyAction;
//# sourceMappingURL=depositStrategy.js.map