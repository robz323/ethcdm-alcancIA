...
const getAllTopicsAction = {
    ...
    handler: async (agent) => {
        const topics = await (0, tools_1.getAllTopics)(agent);
        return {
            status: "success",
            message: "Topics fetched successfully",
            topics: topics,
...
exports.default = getAllTopicsAction;
//# sourceMappingURL=getAllTopics.js.map