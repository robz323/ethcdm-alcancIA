...
const driftSpotTokenSwapAction = {
    ...
    schema: zod_1.z.object({
        fromSymbol: zod_1.z.string().describe("Symbol of the token to swap from"),
        toSymbol: zod_1.z.string().describe("Symbol of the token to swap to"),
        fromAmount: zod_1.z
            .number()
            .positive()
    ...
    handler: async (agent, input) => {
        try {
            const tx = await (0, tools_1.swapSpotToken)(agent, {
...
exports.default = driftSpotTokenSwapAction;
//# sourceMappingURL=swapSpotToken.js.map