...
exports.getDebridgeTokensInfo = getDebridgeTokensInfo;
 ...
 * ```
 */
async function getDebridgeTokensInfo(parameters) {
    const url = `${constants_1.DEBRIDGE_API}/token-list?chainId=${parameters.chainId}`;
