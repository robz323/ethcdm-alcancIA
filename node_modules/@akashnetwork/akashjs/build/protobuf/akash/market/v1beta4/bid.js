...
exports.ResourceOffer = {
    ...
    fromJSON(object) {
        return {
            ...
            resources: isSet(object.resources) ? resources_1.Resources.fromJSON(object.resources) : undefined,
            count: isSet(object.count) ? Number(object.count) : 0
        };
    },
    toJSON(message) {
        const obj = {};
        message.resources !== undefined && (obj.resources = message.resources ? resources_1.Resources.toJSON(message.resources) : undefined);
        message.count !== undefined && (obj.count = Math.round(message.count));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseResourceOffer();
        message.resources = object.resources !== undefined && object.resources !== null ? resources_1.Resources.fromPartial(object.resources) : undefined;
...
exports.MsgCreateBid = {
    ...
    fromJSON(object) {
        return {
            ...
            resourcesOffer: Array.isArray(object?.resourcesOffer) ? object.resourcesOffer.map((e) => exports.ResourceOffer.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.resourcesOffer = object.resourcesOffer?.map(e => exports.ResourceOffer.fromPartial(e)) || [];
        return message;
    }
};
