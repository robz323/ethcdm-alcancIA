...
exports.QueryLeaseResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            escrowPayment: isSet(object.escrowPayment) ? types_1.Payment.fromJSON(object.escrowPayment) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
        message.lease !== undefined && (obj.lease = message.lease ? lease_1.Lease.toJSON(message.lease) : undefined);
        message.escrowPayment !== undefined && (obj.escrowPayment = message.escrowPayment ? types_1.Payment.toJSON(message.escrowPayment) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryLeaseResponse();
        message.lease = object.lease !== undefined && object.lease !== null ? lease_1.Lease.fromPartial(object.lease) : undefined;
        message.escrowPayment = object.escrowPayment !== undefined && object.escrowPayment !== null ? types_1.Payment.fromPartial(object.escrowPayment) : undefined;
        return message;
    }
};
