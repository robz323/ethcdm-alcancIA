                    ...
                    resources?: ({
                        ...
                        storage?: ({
                            ...
                            attributes?: ({
                                ...
                                key?: string | undefined;
                                value?: string | undefined;
                            } & Record<Exclude<keyof I["order"]["spec"]["resources"][number]["resources"]["storage"]["attributes"][number], "$type" | "key" | "value">, never>)[] & Record<Exclude<keyof I["order"]["spec"]["resources"][number]["resources"]["storage"]["attributes"], "$type" | keyof {
                                key?: string | undefined;
                                value?: string | undefined;
                            }[]>, never>) | undefined;
                            quantity?: ({
                                ...
                                val?: Uint8Array | undefined;
                            } & Record<Exclude<keyof I["order"]["spec"]["resources"][number]["resources"]["storage"]["quantity"], "$type" | "val">, never>) | undefined;
                        } & Record<Exclude<keyof I["order"]["spec"]["resources"][number]["resources"]["storage"], "$type" | "attributes" | "quantity">, never>) | undefined;
                        cpu?: ({
                            attributes?: {
                                key?: string | undefined;
                                value?: string | undefined;
                        ...
                        endpoints?: ({
                            ...
                            kind?: import("../../base/v1beta1/endpoint").Endpoint_Kind | undefined;
                        } & Record<Exclude<keyof I["order"]["spec"]["resources"][number]["resources"]["endpoints"][number], "$type" | "kind">, never>)[] & Record<Exclude<keyof I["order"]["spec"]["resources"][number]["resources"]["endpoints"], "$type" | keyof {
                            kind?: import("../../base/v1beta1/endpoint").Endpoint_Kind | undefined;
                        }[]>, never>) | undefined;
    ...
    fromPartial<I extends {
        ...
        bids?: {
            escrowAccount?: {
                ...
                state?: import("../../../akash/escrow/v1beta1/types").Account_State | undefined;
                balance?: {
                    denom?: string | undefined;
                    amount?: string | undefined;
                } | undefined;
            ...
            bid?: {
                state?: import("../../../akash/market/v1beta1/bid").Bid_State | undefined;
                createdAt?: string | number | Long.Long | undefined;
                price?: {
                    denom?: string | undefined;
                    amount?: string | undefined;
        ...
        bids?: ({
            ...
            } & Record<Exclude<keyof I["bids"][number]["escrowAccount"], "$type" | "owner" | "id" | "state" | "balance" | "transferred" | "settledAt">, never>) | undefined;
            bid?: ({
                state?: import("../../../akash/market/v1beta1/bid").Bid_State | undefined;
                createdAt?: string | number | Long.Long | undefined;
                price?: {
...
export declare const QueryLeasesResponse: {
    ...
    fromPartial<I extends {
        ...
        leases?: {
            ...
            escrowPayment?: {
                owner?: string | undefined;
                state?: import("../../../akash/escrow/v1beta1/types").Payment_State | undefined;
                balance?: {
                    denom?: string | undefined;
                    amount?: string | undefined;
                } | undefined;
        ...
        leases?: ({
            ...
            } & Record<Exclude<keyof I["leases"][number]["lease"], "$type" | "state" | "createdAt" | "price" | "leaseId">, never>) | undefined;
            escrowPayment?: ({
                owner?: string | undefined;
                state?: import("../../../akash/escrow/v1beta1/types").Payment_State | undefined;
                balance?: {
...
export declare const QueryLeaseResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["lease"], "$type" | "state" | "createdAt" | "price" | "leaseId">, never>) | undefined;
        escrowPayment?: ({
            owner?: string | undefined;
            state?: import("../../../akash/escrow/v1beta1/types").Payment_State | undefined;
            balance?: {
