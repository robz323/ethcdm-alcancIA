...
exports.Lease = {
    ...
    fromJSON(object) {
        return {
            ...
            closedOn: isSet(object.closedOn) ? long_1.default.fromValue(object.closedOn) : long_1.default.ZERO
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.closedOn !== undefined && (obj.closedOn = (message.closedOn || long_1.default.ZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseLease();
        ...
        message.closedOn = object.closedOn !== undefined && object.closedOn !== null ? long_1.default.fromValue(object.closedOn) : long_1.default.ZERO;
        return message;
    }
};
