...
export declare const Account: {
    ...
    } & Record<Exclude<keyof I, "$type" | "owner" | "id" | "state" | "balance" | "transferred" | "settledAt">, never>>(object: I): Account;
};
export declare const Payment: {
    ...
    } & Record<Exclude<keyof I, "$type" | "owner" | "state" | "balance" | "accountId" | "paymentId" | "rate" | "withdrawn">, never>>(object: I): Payment;
};
