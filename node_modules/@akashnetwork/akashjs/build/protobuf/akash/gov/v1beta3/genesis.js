...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            depositParams: isSet(object.depositParams) ? params_1.DepositParams.fromJSON(object.depositParams) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
        message.depositParams !== undefined && (obj.depositParams = message.depositParams ? params_1.DepositParams.toJSON(message.depositParams) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseGenesisState();
        message.depositParams = object.depositParams !== undefined && object.depositParams !== null ? params_1.DepositParams.fromPartial(object.depositParams) : undefined;
        return message;
    }
};
