...
exports.ResourceUnits = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.storage) {
            storage_1.Storage.encode(v, writer.uint32(26).fork()).ldelim();
        }
        if (message.gpu !== undefined) {
            gpu_1.GPU.encode(message.gpu, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.endpoints) {
            endpoint_1.Endpoint.encode(v, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
