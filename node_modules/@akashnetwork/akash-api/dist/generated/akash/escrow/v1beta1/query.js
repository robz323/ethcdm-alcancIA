...
exports.QueryPaymentsResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            payments: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.payments)
                ? object.payments.map((e) => types_1.Payment.fromJSON(e))
                : [],
            pagination: isSet(object.pagination)
                ? pagination_1.PageResponse.fromJSON(object.pagination)
                : undefined,
    ...
    toJSON(message) {
        ...
        if ((_a = message.payments) === null || _a === void 0 ? void 0 : _a.length) {
            obj.payments = message.payments.map((e) => types_1.Payment.toJSON(e));
        }
        if (message.pagination !== undefined) {
            obj.pagination = pagination_1.PageResponse.toJSON(message.pagination);
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseQueryPaymentsResponse();
        message.payments =
            ((_a = object.payments) === null || _a === void 0 ? void 0 : _a.map((e) => types_1.Payment.fromPartial(e))) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
...
exports.QueryServiceName = 'akash.escrow.v1beta1.Query';
