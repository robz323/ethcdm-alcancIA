...
exports.LeaseRPCClientImpl = exports.LeaseRPCServiceName = exports.ServiceStatusResponse = exports.ServiceStatusRequest = exports.ShellRequest = exports.ServiceLogsResponse = exports.ServiceLogs = exports.ServiceLogsRequest = exports.SendManifestResponse = exports.SendManifestRequest = exports.ServiceStatus = exports.ForwarderPortStatus = exports.LeaseIPStatus = exports.LeaseServiceStatus = void 0;
...
exports.LeaseRPCServiceName = 'akash.provider.lease.v1.LeaseRPC';
class LeaseRPCClientImpl {
    constructor(rpc, opts) {
        this.service = (opts === null || opts === void 0 ? void 0 : opts.service) || exports.LeaseRPCServiceName;
        this.rpc = rpc;
    ...
    SendManifest(request) {
        const data = exports.SendManifestRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'SendManifest', data);
        return promise.then((data) => exports.SendManifestResponse.decode(minimal_1.default.Reader.create(data)));
    }
    ServiceStatus(request) {
        const data = exports.ServiceStatusRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'ServiceStatus', data);
        return promise.then((data) => exports.ServiceStatusResponse.decode(minimal_1.default.Reader.create(data)));
    }
    StreamServiceStatus(request) {
        const data = exports.ServiceStatusRequest.encode(request).finish();
        const result = this.rpc.serverStreamingRequest(this.service, 'StreamServiceStatus', data);
        return result.pipe((0, operators_1.map)((data) => exports.ServiceStatusResponse.decode(minimal_1.default.Reader.create(data))));
    }
    ServiceLogs(request) {
        const data = exports.ServiceLogsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'ServiceLogs', data);
        return promise.then((data) => exports.ServiceLogsResponse.decode(minimal_1.default.Reader.create(data)));
    }
    StreamServiceLogs(request) {
        const data = exports.ServiceLogsRequest.encode(request).finish();
        const result = this.rpc.serverStreamingRequest(this.service, 'StreamServiceLogs', data);
        return result.pipe((0, operators_1.map)((data) => exports.ServiceLogsResponse.decode(minimal_1.default.Reader.create(data))));
    }
}
exports.LeaseRPCClientImpl = LeaseRPCClientImpl;
