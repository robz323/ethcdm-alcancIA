    ...
    fromJSON(object) {
        return {
            ...
            resources: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.resources)
                ? object.resources.map((e) => resourceunit_1.ResourceUnit.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.resources) === null || _a === void 0 ? void 0 : _a.length) {
            obj.resources = message.resources.map((e) => resourceunit_1.ResourceUnit.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.requirements =
            object.requirements !== undefined && object.requirements !== null
                ...
                : undefined;
        message.resources =
            ((_b = object.resources) === null || _b === void 0 ? void 0 : _b.map((e) => resourceunit_1.ResourceUnit.fromPartial(e))) || [];
        return message;
    },
};
