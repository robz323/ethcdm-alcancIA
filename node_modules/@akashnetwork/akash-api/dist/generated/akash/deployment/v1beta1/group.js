...
exports.MsgCloseGroup = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.id !== undefined) {
            obj.id = exports.GroupID.toJSON(message.id);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.id =
            object.id !== undefined && object.id !== null
                ? exports.GroupID.fromPartial(object.id)
                : undefined;
        return message;
    },
};
    ...
    fromJSON(object) {
        return {
            ...
            resources: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.resources)
                ? object.resources.map((e) => exports.Resource.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.resources) === null || _a === void 0 ? void 0 : _a.length) {
            obj.resources = message.resources.map((e) => exports.Resource.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.requirements =
            object.requirements !== undefined && object.requirements !== null
                ...
                : undefined;
        message.resources =
            ((_b = object.resources) === null || _b === void 0 ? void 0 : _b.map((e) => exports.Resource.fromPartial(e))) || [];
        return message;
    },
};
...
exports.Group = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.groupId !== undefined) {
            obj.groupId = exports.GroupID.toJSON(message.groupId);
        }
        if (message.state !== 0) {
            obj.state = group_StateToJSON(message.state);
        }
        if (message.groupSpec !== undefined) {
            obj.groupSpec = exports.GroupSpec.toJSON(message.groupSpec);
        }
        if (!message.createdAt.equals(long_1.default.ZERO)) {
...
exports.Resource = {
    ...
    fromJSON(object) {
        return {
            ...
            resources: isSet(object.resources)
                ? resource_1.ResourceUnits.fromJSON(object.resources)
                : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.resources !== undefined) {
            obj.resources = resource_1.ResourceUnits.toJSON(message.resources);
        }
        if (message.count !== 0) {
            obj.count = Math.round(message.count);
        }
        if (message.price !== undefined) {
            obj.price = coin_1.Coin.toJSON(message.price);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.resources =
            object.resources !== undefined && object.resources !== null
                ? resource_1.ResourceUnits.fromPartial(object.resources)
                : undefined;
        message.count = (_a = object.count) !== null && _a !== void 0 ? _a : 0;
        message.price =
            object.price !== undefined && object.price !== null
                ? coin_1.Coin.fromPartial(object.price)
                : undefined;
        return message;
    },
};
