...
export declare const MsgService: {
    readonly createDeployment: {
        readonly path: "/akash.deployment.v1beta2.Msg/CreateDeployment";
    ...
    readonly depositDeployment: {
        readonly path: "/akash.deployment.v1beta2.Msg/DepositDeployment";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly updateDeployment: {
        readonly path: "/akash.deployment.v1beta2.Msg/UpdateDeployment";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly closeDeployment: {
        readonly path: "/akash.deployment.v1beta2.Msg/CloseDeployment";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly closeGroup: {
        readonly path: "/akash.deployment.v1beta2.Msg/CloseGroup";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly pauseGroup: {
        readonly path: "/akash.deployment.v1beta2.Msg/PauseGroup";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly startGroup: {
        readonly path: "/akash.deployment.v1beta2.Msg/StartGroup";
        readonly requestStream: false;
        readonly responseStream: false;
