...
export declare const MsgService: {
    readonly createBid: {
        readonly path: "/akash.market.v1beta2.Msg/CreateBid";
    ...
    readonly closeBid: {
        readonly path: "/akash.market.v1beta2.Msg/CloseBid";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly withdrawLease: {
        readonly path: "/akash.market.v1beta2.Msg/WithdrawLease";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly createLease: {
        readonly path: "/akash.market.v1beta2.Msg/CreateLease";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly closeLease: {
        readonly path: "/akash.market.v1beta2.Msg/CloseLease";
        readonly requestStream: false;
        readonly responseStream: false;
