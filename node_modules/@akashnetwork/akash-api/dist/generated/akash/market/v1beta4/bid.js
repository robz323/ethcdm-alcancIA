...
exports.BidFilters = exports.Bid = exports.BidID = exports.MsgCloseBidResponse = exports.MsgCloseBid = exports.MsgCreateBidResponse = exports.MsgCreateBid = exports.ResourceOffer = exports.bid_StateToJSON = exports.bid_StateFromJSON = exports.Bid_State = void 0;
...
exports.ResourceOffer = {
    ...
    create(base) {
        return exports.ResourceOffer.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseResourceOffer();
...
exports.MsgCreateBid = {
    ...
    fromJSON(object) {
        return {
            ...
            deposit: isSet(object.deposit)
                ...
                : undefined,
            resourcesOffer: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.resourcesOffer)
    ...
    toJSON(message) {
        ...
        if ((_a = message.resourcesOffer) === null || _a === void 0 ? void 0 : _a.length) {
            obj.resourcesOffer = message.resourcesOffer.map((e) => exports.ResourceOffer.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.resourcesOffer =
            ((_b = object.resourcesOffer) === null || _b === void 0 ? void 0 : _b.map((e) => exports.ResourceOffer.fromPartial(e))) || [];
        return message;
    },
};
