...
exports.OrderFilters = exports.Order = exports.OrderID = exports.order_StateToJSON = exports.order_StateFromJSON = exports.Order_State = void 0;
...
exports.OrderID = {
    ...
    create(base) {
        return exports.OrderID.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseOrderID();
...
exports.Order = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.orderId !== undefined) {
            obj.orderId = exports.OrderID.toJSON(message.orderId);
        }
        if (message.state !== 0) {
            obj.state = order_StateToJSON(message.state);
        }
        if (message.spec !== undefined) {
            obj.spec = groupspec_1.GroupSpec.toJSON(message.spec);
        }
        if (!message.createdAt.equals(long_1.default.ZERO)) {
...
exports.OrderFilters = {
    ...
    create(base) {
        return exports.OrderFilters.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseOrderFilters();
