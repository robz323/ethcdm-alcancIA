...
export declare class PDAUtil {
    static getWhirlpool(programId: PublicKey, whirlpoolsConfigKey: PublicKey, tokenMintAKey: PublicKey, tokenMintBKey: PublicKey, feeTierIndex: number): import("@orca-so/common-sdk").PDA;
    ...
    static getFeeTier(programId: PublicKey, whirlpoolsConfigAddress: PublicKey, feeTierIndex: number): import("@orca-so/common-sdk").PDA;
