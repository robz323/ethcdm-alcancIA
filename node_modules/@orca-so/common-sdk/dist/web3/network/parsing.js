...
let ParsableTokenAccountInfo = class ParsableTokenAccountInfo {
    ...
    static parse(address, data) {
        ...
        try {
            return { ...(0, spl_token_1.unpackAccount)(address, data, data.owner), tokenProgram: data.owner };
        }
        catch (e) {
...
let ParsableMintInfo = class ParsableMintInfo {
    ...
    static parse(address, data) {
        ...
        try {
            return { ...(0, spl_token_1.unpackMint)(address, data, data.owner), tokenProgram: data.owner };
        }
        catch (e) {
