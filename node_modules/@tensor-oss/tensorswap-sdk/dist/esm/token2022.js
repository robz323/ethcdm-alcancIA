...
export const getDistributionAccount = (collection, paymentMint = PublicKey.default) => {
    const [distributionAccount] = PublicKey.findProgramAddressSync([collection.toBuffer(), paymentMint.toBuffer()], WNS_DISTRIBUTION_PROGRAM_ID);
