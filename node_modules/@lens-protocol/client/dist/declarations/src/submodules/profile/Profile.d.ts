...
export declare class Profile {
     ...
     * ```
     */
    follow(request: FollowLensManagerRequest): PromiseResult<RelaySuccessFragment | LensProfileManagerRelayErrorFragment, CredentialsExpiredError | NotAuthenticatedError>;
    /**
