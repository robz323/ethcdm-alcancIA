...
import type { ClaimProfileWithHandleRequest, CreateProfileRequest, CreateProfileWithHandleRequest, HideManagedProfileRequest, LastLoggedInProfileRequest, OwnedHandlesRequest, ProfilesManagedRequest, UnhideManagedProfileRequest, UserCurrentRateLimitRequest } from "../../graphql/types.generated.js";
...
export declare class Wallet {
     ...
     * ```
     */
    hideManagedProfile(request: HideManagedProfileRequest): PromiseResult<void, CredentialsExpiredError | NotAuthenticatedError>;
    /**
     ...
     * ```
     */
    unhideManagedProfile(request: UnhideManagedProfileRequest): PromiseResult<void, CredentialsExpiredError | NotAuthenticatedError>;
    /**
     * Fetch user nonces.
     *
     * ⚠️ Requires authenticated LensClient.
