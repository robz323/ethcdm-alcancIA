...
export type HideManagedProfileMutation = {
    hideManagedProfile: string | null;
};
...
export type UnhideManagedProfileMutation = {
    unhideManagedProfile: string | null;
};
...
export declare const HideManagedProfileDocument: DocumentNode;
export declare const UnhideManagedProfileDocument: DocumentNode;
...
export declare function getSdk(client: GraphQLClient, withWrapper?: SdkFunctionWrapper): {
    ...
    HideManagedProfile(variables: HideManagedProfileMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
        data: HideManagedProfileMutation;
        extensions?: any;
        headers: Dom.Headers;
        status: number;
    }>;
    UnhideManagedProfile(variables: UnhideManagedProfileMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
