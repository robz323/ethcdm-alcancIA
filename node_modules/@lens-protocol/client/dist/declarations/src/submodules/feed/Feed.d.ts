...
import { LatestPaidActionsRequest } from "./types.js";
/**
...
export declare class Feed {
     ...
     * ```
     */
    latestPaidActions(request?: LatestPaidActionsRequest): PromiseResult<PaginatedResult<FollowPaidActionFragment | OpenActionPaidActionFragment>, CredentialsExpiredError | NotAuthenticatedError>;
}
