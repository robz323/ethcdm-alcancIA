...
import { FetchPublicationOptions } from "./types.js";
/**
...
export declare class Publication {
     ...
     * ```
     */
    postOnchain(request: OnchainPostRequest): PromiseResult<RelaySuccessFragment | LensProfileManagerRelayErrorFragment, CredentialsExpiredError | NotAuthenticatedError>;
    /**
