...
var asyncToGenerator = require('./asyncToGenerator-e5e0a789.cjs.dev.js');
var sharedKernel = require('@lens-protocol/shared-kernel');
var environments_dist_lensProtocolGatedContentEnvironments = require('./environments-67a6b3bf.cjs.dev.js');
...
var toLitSupportedChainName = function toLitSupportedChainName(chainId) {
  switch (chainId) {
    ...
    case environments_dist_lensProtocolGatedContentEnvironments.SupportedChainId.AMOY:
      return environments_dist_lensProtocolGatedContentEnvironments.SupportedChains.AMOY;
        ...
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return sharedKernel.update(metadata, paths, function (value) {
        ...
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", sharedKernel.update(encrypted, paths, function (value) {
...
exports.testing = environments_dist_lensProtocolGatedContentEnvironments.testing;
