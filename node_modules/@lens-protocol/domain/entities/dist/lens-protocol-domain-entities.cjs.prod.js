...
var PublicationReport = require('../../dist/PublicationReport-6bdcbae5.cjs.prod.js');
var Publication = require('../../dist/Publication-5ba726a5.cjs.prod.js');
var Transactions = require('../../dist/Transactions-8e83f9fb.cjs.prod.js');
var createClass = require('../../dist/createClass-51a9a1ed.cjs.prod.js');
var createSuper = require('../../dist/createSuper-ba2b1f7d.cjs.prod.js');
var wrapNativeSuper = require('../../dist/wrapNativeSuper-e2e5f3e0.cjs.prod.js');
...
var InsufficientGasError = /*#__PURE__*/function (_Error) {
  createSuper._inherits(InsufficientGasError, _Error);
  var _super = createSuper._createSuper(InsufficientGasError);
  function InsufficientGasError(asset) {
    var _this;
    createClass._classCallCheck(this, InsufficientGasError);
    _this = _super.call(this, 'Not enough gas to pay for the operation');
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this), "name", 'InsufficientGasError');
    _this.asset = asset;
    return _this;
  }
...
var PendingSigningRequestError = /*#__PURE__*/function (_Error2) {
  createSuper._inherits(PendingSigningRequestError, _Error2);
  var _super2 = createSuper._createSuper(PendingSigningRequestError);
  function PendingSigningRequestError() {
    ...
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this2), "name", 'PendingSigningRequestError');
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this2), "message", 'Clear or approve the pending wallet request and retry.');
    return _this2;
  }
...
var WalletConnectionError = /*#__PURE__*/function (_Error3) {
  createSuper._inherits(WalletConnectionError, _Error3);
  var _super3 = createSuper._createSuper(WalletConnectionError);
  function WalletConnectionError(reason) {
    var _this3;
    createClass._classCallCheck(this, WalletConnectionError);
    _this3 = _super3.call(this, "Wallet connection failed due to ".concat(reason, " error"));
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this3), "name", 'WalletConnectionError');
...
var UserRejectedError = /*#__PURE__*/function (_Error4) {
  createSuper._inherits(UserRejectedError, _Error4);
  var _super4 = createSuper._createSuper(UserRejectedError);
  function UserRejectedError() {
    ...
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this4), "name", 'UserRejectedError');
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this4), "message", 'User rejected the request');
    return _this4;
  }
