...
var SignFrameAction = /*#__PURE__*/function () {
  function SignFrameAction(activeWallet, gateway, presenter) {
    _classCallCheck(this, SignFrameAction);
    this.activeWallet = activeWallet;
    this.gateway = gateway;
    this.presenter = presenter;
  }
  _createClass(SignFrameAction, [{
    key: "execute",
    value: function () {
      var _execute = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        var signedAction, wallet, unsignedAction, signedActionResult;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!request.signless) {
              ...
              _context.next = 3;
              return this.gateway.signFrameAction(request.input);
            case 3:
              signedAction = _context.sent;
            ...
            case 8:
              ...
              _context.next = 11;
              return this.gateway.createUnsignedFrameAction(request.input);
            case 11:
              unsignedAction = _context.sent;
              _context.next = 14;
              return wallet.signFrameAction(unsignedAction);
            case 14:
              signedActionResult = _context.sent;
...
export { InsufficientAllowanceError, InsufficientFundsError, InviteWallets, SignFrameAction, TokenAvailability, WalletAlreadyInvitedError };
