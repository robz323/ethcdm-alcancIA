...
import { SignedFrameAction, UnsignedFrameAction } from "./FrameAction.js";
...
export declare abstract class Wallet {
    ...
    abstract signFrameAction<TData>(unsignedAction: UnsignedFrameAction<TData>): PromiseResult<SignedFrameAction<TData>, PendingSigningRequestError | UserRejectedError | WalletConnectionError>;
