...
var asyncToGenerator = require('../../dist/asyncToGenerator-4a0c94a6.cjs.prod.js');
...
var ReferencePolicyConfig = require('../../dist/ReferencePolicyConfig-ff2c3d58.cjs.prod.js');
var waitFor = require('wait-for-expect');
var TokenAllowance = require('../../dist/TokenAllowance-5aaf158d.cjs.prod.js');
require('../../dist/SponsorshipReady-9f97222b.cjs.prod.js');
...
function mockMomokaPublicationId() {
  return "".concat(mockProfileId(), "-").concat(faker.faker.datatype.hexadecimal({
    length: 2
  }), "-DA-").concat(faker.faker.datatype.hexadecimal({
    length: 2
  }));
}
function mockWallet() {
...
function mockUnknownReferencePolicyConfig(overrides) {
  return _objectSpread2(_objectSpread2({
    ...
    type: ReferencePolicyConfig.ReferencePolicyType.UNKNOWN
  });
}
...
exports.mockMomokaPublicationId = mockMomokaPublicationId;
...
exports.mockUnknownReferencePolicyConfig = mockUnknownReferencePolicyConfig;
