...
export const ibcDenom = (paths, coinMinimalDenom) => {
    ...
    return ('ibc/' +
        Buffer.from(new Uint8Array(new sha256().update(Buffer.from(denom)).digest()))
            .toString('hex')
            .toUpperCase());
};
...
export const getIbcAssetPath = (ibc, chain, counterparty, assets, base) => {
    ...
    return [
        ...memo,
        ...getIbcAssetPath(ibc, counterparty, trace.counterparty.chain_name, assets, trace.counterparty.base_denom
        // base
        )
    ];
};
